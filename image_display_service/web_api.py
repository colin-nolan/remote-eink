...
from image_display_service.common import DISPLAY_CONTROLLERS_CONFIG_KEY
...
def create_app(display_controllers: Collection[DisplayController]) -> FlaskApp:
    ...
    app.add_api(OPEN_API_LOCATION, resolver=RestyResolver("image_display_service.api"), strict_validation=True)
    CORS(app.app)
